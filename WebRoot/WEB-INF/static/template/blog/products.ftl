			...
			<div class="p_content ">
				<div id="com_thenm_list" class="content">
						...
						<div class="p_p_list">
							<ul>
								<li>
									<dl>
										<dd>
											<a href="${BASE_PATH }/blog/products/detail/${article.articleId}.htm"> <img src="/91bc/${article.picture}" alt="${article.title}" /> </a>
										</dd>
										<dt>
											<a href="${BASE_PATH }/blog/products/detail/${article.articleId}.htm">${article.title}</a>
										</dt>
									</dl>
								</li>
					...
					<div class="navPage pagebar">
						<ul>
							<li><a title="第一页" href="${BASE_PATH }/folder/products.htm?p=1">|&lt;</a></li>
							<#if (pageNum > 1)>
								<li><a title="上一页" href="${BASE_PATH }/folder/products.htm?p=${pageNum-1}">&lt;&lt;</a></li>
								<li><a title="第${pageNum-1}页" href="${BASE_PATH }/folder/products.htm?p=${pageNum-1}">${pageNum-1}</a></li>
							</#if>
							<li><a title="" class="pagebarCurrent">${pageNum}</a></li>
							<#if (pageNum < articleList.pageCount) >
								<li><a title="第${pageNum+1}页" href="${BASE_PATH }/folder/products.htm?p=${pageNum+1}">${pageNum+1}</a></li>
								<li><a title="下一页" href="${BASE_PATH }/folder/products.htm?p=${pageNum+1}">&gt;&gt;</a></li>
							</#if>
							<li><a title="最后一页" href="${BASE_PATH }/folder/products.htm?p=${articleList.pageCount}">&gt;|</a></li>
						</ul>
					</div>
				</div>
			</div>
