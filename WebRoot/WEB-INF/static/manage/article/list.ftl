                ...
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="breadcrumb" style="margin-bottom:0px;">
                            <li>
                                <a href="${BASE_PATH}/manage/article/list.htm">全部</a>
                            </li>
                        <#list folderNameList as pathFolder>
                            <li>
                    ...
                    <div class="col-lg-8">
                        <a class="btn btn-primary" style="float:right;"
                           href="${BASE_PATH}/manage/article/add.htm?folderId=${folderId}">增加文章</a>
                    </div>
                </div>
            </header>
                    ...
                    <div role="grid" class="dataTables_wrapper" id="hidden-table-info_wrapper">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td>
                                    <!-- Icons -->
                                    <a href="${BASE_PATH}/manage/article/update.htm?articleId=${e.articleId}"
                                       title="修改">
                                        编辑
                                    </a>
                                    |
                                    <a href="javascript:void(0);" class="js_article_delete" articleId="${e.articleId}"
                                       title="是否删除文章">
                                        删除
                                    </a>
                                    |
                                    <a href="${BASE_PATH}/manage/article/preview.htm?articleId=${e.articleId}"
                                       target="_blank">
                                        预览
                                    </a>
                                </td>
