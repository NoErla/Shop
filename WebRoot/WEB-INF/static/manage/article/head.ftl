...
<script type="text/javascript" charset="utf-8"
	src="${TEMPLATE_BASE_PATH}/assets/ueditor/ueditor.all.min.js?v=${config_v}">
...
<div class="top_head" style="height:30px;line-height:30px;box-shadow:box-shadow: 2px 2px 1px #CCC; z-index:1; ">
  <div class="member_login" style="width:1000px;margin:0 auto;text-align:right;">欢迎您 &nbsp;&nbsp;|&nbsp;&nbsp;
  			<a href="#" onclick="#">会员中心</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="${BASE_PATH}/user/logout.htm" onclick="#"> 退出登录</a> 
  			 </div>
</div>
	<div class="header">
		<div class="header_in">
			<div class="logo" id="com_logo">
				<a href="index.htm"> <img
					src="${BASE_PATH}/static/templates/images/logo.png" alt="logo" />
				</a>
			</div>
			<div class="header_r">
				<div class="lan">
	...
	<div id="donetion" style="position:fixed;right:30px;top:55%;width:50px;height:150px;background:#bc192a;border-radius:10px;"><a href="${BASE_PATH}/blog/pay/order.htm" style="height:130px;padding-top:10px;z-index:1;color:#FFF;line-height:30px;display:block;font-size:30px; text-align:center;">我要参与</a></div>
	</body>
