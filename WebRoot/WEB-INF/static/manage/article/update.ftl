				...
				<section class="panel">
					...
					<div class="panel-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <select class="form-control" name="projectId" style="font-size:15px;width: 300px;">
                             	 <option selected value="">请选择...</option>
			                   		<#list projectAll as project>
			                   			
			                        	<option value="${project.id}" <#if article.projectId??><#if project.id==article.projectId>selected</#if><#else></#if>>
