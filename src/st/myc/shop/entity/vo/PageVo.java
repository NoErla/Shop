...
public class PageVo<T> {
    ...
    public String getPageNumHtml() {
        ...
        if (this.getPageNum() != 1) {
            sb.append("<li><a href='");
            sb.append(this.getUrl(1));
            sb.append("' title='首页'>&lt;&lt;</a></li>");
            sb.append("<li><a href='");
            sb.append(this.getUrl(this.getPageNum() - 1));
            sb.append("' title='上一页'>&lt;</a></li>");
        }
        // 页码
        if (this.getPageCount() != 1) {
            ...
            for (int i = startNum; i <= endNum; i++) {
                if (i == pageNum) {
                    ...
                    sb.append(this.getUrl(i));
                    sb.append("' class='number current' title='");
                    sb.append(i);
                    sb.append("'>");
                    sb.append(i);
                    sb.append("</a></li>");
        ...
        if (this.getPageNum() < this.getPageCount()) {
            sb.append("<li><a href='");
            sb.append(this.getUrl(this.getPageNum() + 1));
            sb.append("' title='下一页'>&gt;</a></li>");
            sb.append("<li><a href='");
            sb.append(this.getUrl(this.getPageCount()));
            sb.append("' title='末页'>&gt;&gt;</a></li>");
        }
        sb.append("</ul>");
        return sb.toString();
    }
